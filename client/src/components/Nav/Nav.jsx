...
function Nav(props) {
	...
	useEffect(() => {
		axios.get("/countries").then((data) => setContinents(data.data));
		axios.get("/activities").then((data) => setActivities(data.data));
	}, []);
					...
					<li>
						...
						>
							...
							{continents ? (
								...
								<h1>Hubo un problema con la Ap"</h1>
							)}
						</select>
					</li>
					<li>
